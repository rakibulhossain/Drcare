            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-5 col-6 text-right m-b-30">
                        <a href="/edit_profile" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Edit Profile</a>
                    </div>
                </div>
                            ...
                            <div class="profile-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <a href=""><img class="avatar" src="{{ asset('user_image/'.$user->profile_image) }}" alt=""></a>
                                    </div>
                                </div>
