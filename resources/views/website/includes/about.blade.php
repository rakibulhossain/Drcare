<section class="ftco-section ftco-no-pt ftc-no-pb">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-5 p-md-5 img img-2 mt-5 mt-md-0" style="background-image: url(website_ui/images/about.jpg);">
					</div>
		...
		<section class="ftco-intro" style="background-image: url(website_ui/images/bg_3.jpg);" data-stellar-background-ratio="0.5">
